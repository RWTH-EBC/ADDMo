...
model1 = LinearReg()
model2= ScikitMLP()
a= df['Longitude'].values.astype(np.double)
print(a.ndim)
...
m2= ModelFactory()
m3= ModelFactory()
m2= m2.load_model(r"C:\Users\mre-rpa\PycharmProjects\addmo\addmo-automated-ml-regression\0000_testfiles\LinearReg.joblib")
