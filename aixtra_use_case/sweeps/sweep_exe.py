...
def create_config():  # Todo set
    ...
    config = config_blueprints.no_tuning_config_SVR(config)
    config.experiment_name = f"8_{config.simulation_data_name}_NovDezSelect_SVR"
    return config
...
def create_sweep():
    ...
    sweep_configuration = config_sweep.sweep_SVR_params()  # Todo set
