...
from addmo.s3_model_tuning.scoring.metrics.metric_factory import MetricFactory
from addmo.s3_model_tuning.scoring.validation_splitting.splitter_factory import (
    SplitterFactory,
)
from addmo.s3_model_tuning.scoring.validator_factory import ValidatorFactory
from addmo.s3_model_tuning.hyperparameter_tuning.hyparam_tuning_factory import HyperparameterTunerFactory
...
def recursive_feature_selection_wrapper_scikit_learn(
    ...
    x_processed = selector.transform(X=x)  # transform the system_data
    return x_processed
