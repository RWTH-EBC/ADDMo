...
from aixtra.extrapolation_detection.n_D_extrapolation.true_validity_domain import infer_threshold
...
def tune_detector(detector_name: str, x_train, x_val, y_val, config_detector: \
    ...
    # set system_data of the detector
...
def untuned_detector(detector_name: str, x_train, x_val, outlier_fraction):
    ...
    detector.threshold = nd_threshold
