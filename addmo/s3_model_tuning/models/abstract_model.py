...
class ModelMetadata(BaseModel):
    ...
    instructions: str = Field(
        ...
        description="Instructions for passing input system_data for making predictions.",
    )
...
class AbstractMLModel(ABC):
    ...
    def predict(self, x: pd.DataFrame):
        """
        Make predictions on the given input system_data.

        Args:
            x: Input system_data for making predictions.
    ...
    def load_regressor(self, model_instance, input_shape=None):
        ...
        Args:
            ...
            input_shape: input system_data shape which is used to initialize loaded model.
        """
    ...
    def to_scikit_learn(self, x=None):
        ...
        Args:
            x: Input system_data used for building the regressor. (Only needed for Keras)
