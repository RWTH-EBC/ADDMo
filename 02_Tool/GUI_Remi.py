...
class AutomatedTraining(App):
    ...
    def main(self):
        ...
        if True:
            ...
            ContDT_ColumnOfSignal, self.ColumnOfSignalDT = spinbox("Column of signal", self.info_ColumnOfSignal, 7,0,float("inf")).do()
        ...
        if True:
            ...
            ContMT_EndTesting, self.EndTestingMT = text("End of testing", self.info_EndDateTesting, '2000-01-01 00:45:00').do()
