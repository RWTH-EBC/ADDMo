...
class byfeature_splitter:
    ...
    def splitter(self, Dataseries):
        ...
        if type(self.Features_Train) != str:
            ...
            ):  # check whether Dataseries is within train or test period
    ...
    def main(self):
        ...
        for key in Dic:
            ...
            _dic = self.Estimator(
                ...
                Recursive=False,
            )  # train and predict for the given data #recursive has to be turned of (doesnt work with individual model), it is done later in this function for individual models
