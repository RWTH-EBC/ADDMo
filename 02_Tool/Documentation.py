...
def documentation_DataTuning(DT_Setup_object, timestart, timeend):
    ...
    DfMethodology.at[7, "FeatureConstruction"] = "Manual creation of FeatureLags= %s" % DT_Setup_object.ManFeaturelagCreate
    ...
    if DT_Setup_object.UnivariateFilter == True:
        ...
        DfMethodology.at[9, "FeatureSelection"] = "Search mode threshold parameter= %s" % DT_Setup_object.Param_univariate_filter
    ...
    if (DT_Setup_object.RecursiveFeatureSelection or DT_Setup_object.EmbeddedFeatureSelectionThreshold) == True:
        ...
        if DT_Setup_object.RecursiveFeatureSelection == True:
            DfMethodology.at[12, "FeatureSelection"] = "Number of Features to select= %s" % DT_Setup_object.N_feature_to_select_RFE
        ...
        if DT_Setup_object.EmbeddedFeatureSelectionThreshold == True:
            DfMethodology.at[15, "FeatureSelection"] = "Feature importance threshold = %s" % DT_Setup_object.Threshold_embedded
