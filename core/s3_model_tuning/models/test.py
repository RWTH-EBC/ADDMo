...
model1.save_regressor('core/s3_model_tuning/models', 'Linear.joblib')
model2.save_regressor('core/s3_model_tuning/models','MLP.onnx')

# Load the serialized model
#m2= ModelFactory()
#m3= ModelFactory()
#m2= m2.load_model("core\s3_model_tuning\models\Linear.joblib")
#m3= m3.load_model("core\s3_model_tuning\models\MLP.onnx")
#print(m2)
