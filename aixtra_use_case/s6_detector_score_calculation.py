...
from aixtra.extrapolation_detection.detector import scoring
from aixtra_use_case.config.ed_experiment_config import (
    ExtrapolationExperimentConfig,
)
from aixtra.extrapolation_detection.detector.detectors import AbstractDetector
...
def exe(config: ExtrapolationExperimentConfig):
    ...
    true_valitidy_grid = loading_saving_aixtra.read_csv(
    ...
    for detector_file in os.listdir(directory):
        if detector_file.endswith(".pkl"):
            ...
            # load detector
            detector: AbstractDetector = loading_saving_aixtra.read_pkl(
            ...
            novelty_threshold = loading_saving_aixtra.read_csv(
