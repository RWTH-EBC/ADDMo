...
def iterative_evaluation(
    ...
    (TestData_X, TestData_Y) = SVF.split_signal_and_features(
        MT_Setup_Object_PO.NameOfSignal, TestData
    )

    if os.path.isfile(
        os.path.join(MT_Setup_Object_PO.ResultsFolder, "ScalerTracker.save")
    ):  # if scaler was used
...
def main_OnlyPredict(MT_Setup_object_PO):
    print(
        ...
        % (
            MT_Setup_object_PO.NameOfData,
            MT_Setup_object_PO.NameOfExperiment,
