...
def embedded__recursive_feature_selection(
    ...
    def index_column_keeper(X_Data, Y_Data, support, X_Data_transformed):
        ...
        Y = pd.DataFrame(
            Y_Data, columns=[MT_Setup_Object.NameOfSignal]
    ...
    if Documentation == True:
        ...
        )  # merge test and train period back together
        return (
...
def Bayes(
    ...
    def hyperopt(params, _X_train, _Y_train, _X_test, _Y_test, Indexer):
        ...
        )  # create the specific train and test data
    ...
    BestData.to_pickle(
        os.path.join(
            MT_Setup_Object_AFB.PathToPickles,
...
def main_FinalBayes(MT_Setup_Object_AFB):
    ...
    print(
        ...
        % (
            MT_Setup_Object_AFB.NameOfData,
            MT_Setup_Object_AFB.NameOfExperiment,
