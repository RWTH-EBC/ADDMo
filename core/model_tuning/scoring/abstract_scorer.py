...
from core.model_tuning.scoring.validation_splitting.splitter_factory import SplitterFactory
...
class ValidationScoring(ABC):
    ...
    def __init__(self, config: ModelTuningSetup):
        self.metric = MetricFactory.metric_factory(config.validation_score_metric, config.validation_score_metric_kwargs)
