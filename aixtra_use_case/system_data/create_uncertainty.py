...
xy_tot: pd.DataFrame = loading_saving_aixtra.read_csv(simulation_data_name, directory=None, index_col=False)
...
np.random.seed(42)
# Number of system_data points to generate
num_data_points = xy_tot.shape[0]
# Generate random system_data from a normal distribution with mean 0 and std dev 1
