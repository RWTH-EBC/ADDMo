...
def run_all(config, project_name):
...
project_name = f"TEST_{config.simulation_data_name}" #Todo: Set
# project_name = "Test"
...
if __name__ == '__main__':
    wandb.agent(sweep_id, function=lambda: run_all(config, project_name), project=project_name)
