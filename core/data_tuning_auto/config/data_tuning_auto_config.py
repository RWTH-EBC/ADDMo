...
class DataTuningAutoSetup(BaseConfig):
    ...
    def __init__(self, **kwargs):
        ...
        self.create_differences: bool = True  # Feature difference creation (building the
        # derivative of the features)

        # manual construction of target lags
        self.create_manual_target_lag:bool = True
        ...
        self.create_manual_feature_lags:bool = True
        ...
        self.create_automatic_feature_lags = True
        self.minimum_feature_lag: int = 1
        self.maximum_feature_lag: int = 20

        # -----------------------FeatureSelection Variables-------------------------------

        self.manual_feature_selection:bool= True  # Manual selection of Features by their Column
        ...
        self.filter_ICA:bool = True  # Filter: Independent Component Analysis(ICA)

        self.filter_univariate:bool = True  # Filter univariate by scikit-learn
