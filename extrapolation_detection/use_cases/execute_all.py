...
from extrapolation_detection.use_cases import (
    ...
    s3_0_regressor_error_calculation,
...
config.experiment_name = "Boptest_TAir_mid_reduced_big_ANN_fix_threshold"
...
config.true_outlier_threshold = 0.09276474957482335  # like of small ann
...
s3_0_regressor_error_calculation.exe_regressor_error_calculation(config)
