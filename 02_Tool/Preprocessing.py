    ...
    if (
        sum(
            map(
                bool,
                [
                    DT_Setup_object.StandardScaling,
                    DT_Setup_object.RobustScaling,
                    DT_Setup_object.NoScaling,
                ],
            )
        )
        != 1
